...
* Det kan være svært at vurdere plots; kan evt. sammenligne med simulerede data?

* Man laver lignende i lineære mixed models

* Vanskeligere at lave modelkontrol i modeller der ikke er baseret på normalfordelingen. Kan evt. nævne kumulerede residualer
...
### Alternative to transformation: Model for the varinces with the gls-function
